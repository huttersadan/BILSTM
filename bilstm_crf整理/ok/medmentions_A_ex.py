...
# train_path = "data_st21/train_mask.json"
# dev_path = "data_st21/dev.json"
# test_path = "data_st21/test.json"
train_path = "/media/sdd1/luosx/NER/our_method_datasets/medmention_extratraining/train_mask.json"
dev_path = "/media/sdd1/luosx/NER/our_method_datasets/medmention_extratraining/dev.json"
test_path = "/media/sdd1/luosx/NER/our_method_datasets/medmention_extratraining/test.json"
...
def evaluating(model, datas, best_F, dataset="Train"):
    ...
    with open("data_medmentions/outcome_medmention_A_ex.txt","a+",encoding="UTF-8") as file:
        file.write("\n")
        ...
        for i, index in enumerate(np.random.permutation(len(train_dataset))):
            ...
            if count%100000 == 0:
                ...
                if new_dev_F>best_dev__F:
                    ...
                    torch.save(model.state_dict(), "data_medmentions/medmentions_ex_A.pth")
                model.train(True)
            # if count % (eval_every*2) == 0 or count > (eval_every*3):
            #     model.train(False)
            #
