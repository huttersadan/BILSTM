...
total_path = '/media/sdd1/luosx/NER/our_method_datasets/bc5'
train_path = total_path + "/train_mask.json"
...
def evaluating(model, datas, best_F, dataset="Train"):
    ...
    with open("bc5parse/outcome_parse_test.txt","a+",encoding="UTF-8") as file:
        file.write("\n")
...
#                     torch.save(model.state_dict(), "bc5parse/bc_A.pth")
#
#
#                 model.train(True)
#
...
model.load_state_dict(torch.load("bc5parse/bc_A.pth"))
model.train(False)
